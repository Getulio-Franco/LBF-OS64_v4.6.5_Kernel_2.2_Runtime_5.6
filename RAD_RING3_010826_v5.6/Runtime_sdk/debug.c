...
// Componente RAD do Monitor de Log
...
int main(int argc, char* argv[]) {
    ...
    GUI_InitApplication(&MyApp, my_app_slot, "Kernel Live Debug Monitor v1.0", winWidth, winHeight);
    ...
    while(1) {
        ...
        // Reduz o tempo de sleep para 16ms (~60 FPS) para respostas rapidas de log
        sys_sleep(16);
    }
